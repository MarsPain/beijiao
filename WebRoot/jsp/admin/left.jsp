...
<html>
  ...
  <body style="background:#f0f9fd;">
    ...
    <span><img src="images/leftico01.png" /></span>信息管理
        ...
        <li><cite></cite><a href="jsp/admin/focus.jsp" target="">热点关注</a><i></i></li>
        ...
        <li><cite></cite><a href="jsp/admin/polInterprete.jsp" target="rightFrame">政策解读</a><i></i></li>
    ...
    <ul class="menuson">
        <li><cite></cite><a href="index/getAllUser" target="rightFrame">用户账号管理</a><i></i></li>
